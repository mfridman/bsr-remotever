...
const file_buf_registry_module_v1_commit_proto_rawDesc = "" +
	...
	"\x12source_control_url\x18\a \x01(\tB\x0e\xbaH\v\xd8\x01\x01r\x06\x18\xff\x01\x88\x01\x01R\x10sourceControlUrl:\x06\xea\xc5+\x02\x10\x01B\xeb\x01\n" +
	"\x1acom.buf.registry.module.v1B\vCommitProtoP\x01ZEgithub.com/mfridman/bsr-remotever/gen/buf/registry/module/v1;modulev1\xa2\x02\x03BRM\xaa\x02\x16Buf.Registry.Module.V1\xca\x02\x16Buf\\Registry\\Module\\V1\xe2\x02\"Buf\\Registry\\Module\\V1\\GPBMetadata\xea\x02\x19Buf::Registry::Module::V1b\x06proto3"

var (
	file_buf_registry_module_v1_commit_proto_rawDescOnce sync.Once
	file_buf_registry_module_v1_commit_proto_rawDescData []byte
)
...
func file_buf_registry_module_v1_commit_proto_rawDescGZIP() []byte {
	file_buf_registry_module_v1_commit_proto_rawDescOnce.Do(func() {
		file_buf_registry_module_v1_commit_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_buf_registry_module_v1_commit_proto_rawDesc), len(file_buf_registry_module_v1_commit_proto_rawDesc)))
	})
