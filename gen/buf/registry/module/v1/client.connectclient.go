...
type Client struct {
	...
	userAgent     string
	common        service
	CommitService *CommitServiceClient
...
func NewClient(baseURL string, opts ...ClientOption) *Client {
	c := &Client{
		...
		baseURL:    baseURL,
		userAgent:  "connectclient-go/v0.1.2",
	}
	for _, opt := range opts {
		opt.apply(c)
	}
	c.common.client = c
	c.CommitService = (*CommitServiceClient)(&c.common)
	c.LabelService = (*LabelServiceClient)(&c.common)
	return c
}
