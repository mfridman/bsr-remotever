...
const file_buf_registry_module_v1_label_service_proto_rawDesc = "" +
	...
	"\x0fUnarchiveLabels\x12..buf.registry.module.v1.UnarchiveLabelsRequest\x1a/.buf.registry.module.v1.UnarchiveLabelsResponse\"\x03\x90\x02\x02B\xf1\x01\n" +
	"\x1acom.buf.registry.module.v1B\x11LabelServiceProtoP\x01ZEgithub.com/mfridman/bsr-remotever/gen/buf/registry/module/v1;modulev1\xa2\x02\x03BRM\xaa\x02\x16Buf.Registry.Module.V1\xca\x02\x16Buf\\Registry\\Module\\V1\xe2\x02\"Buf\\Registry\\Module\\V1\\GPBMetadata\xea\x02\x19Buf::Registry::Module::V1b\x06proto3"

var (
	file_buf_registry_module_v1_label_service_proto_rawDescOnce sync.Once
	file_buf_registry_module_v1_label_service_proto_rawDescData []byte
)
...
func file_buf_registry_module_v1_label_service_proto_rawDescGZIP() []byte {
	file_buf_registry_module_v1_label_service_proto_rawDescOnce.Do(func() {
		file_buf_registry_module_v1_label_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_buf_registry_module_v1_label_service_proto_rawDesc), len(file_buf_registry_module_v1_label_service_proto_rawDesc)))
	})
